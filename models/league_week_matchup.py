class league_week_matchup(object):
  ...
  def __init__(self, week, week_start, status, is_playoffs, is_consolation, is_matchup_recap_available, is_tied, winner_team_key, team_key_1, team_1_points, team_key_2 , team_2_points ):
    self.week = week
  ...
  def printME(self):
    ...
    print("week: %s\nweek_start: %s\nstatus: %s\nis_playoffs: %s\nis_consolation: %s\nis_matchup_recap_available: %s\nis_tied: %s\nwinner_team_key: %s\nteam key 1: %s\nteam 1 points: %s\nteam key 2: %s\nteam 2 points: %s\n" % \
      (self.week, self.week_start, self.status, self.is_playoffs, self.is_consolation, self.is_matchup_recap_available, self.is_tied, self.winner_team_key, self.team_key_1, self.team_1_points, self.team_key_2, self.team_2_points))